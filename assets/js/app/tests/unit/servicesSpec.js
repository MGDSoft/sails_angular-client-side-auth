  ...
  describe('Auth', function() {
    ...
    describe('register', function() {
      it('should make a request and invoke callback', function() {
        ...
        var error = function() {};
        $httpBackend.expectPOST('/v1/user/create').respond();
      ...
      it('should append the user', function() {
        var success = function() {};
        var error = function() {};
        $httpBackend.expectPOST('/v1/user/create').respond({ 'user': 'foo' });
        Auth.register({}, success, error);
        $httpBackend.flush();
    ...
    describe('login', function() {
      it('should make a request and invoke callback', function() {
        ...
        var error = function() {};
        $httpBackend.expectPOST('/v1/auth/login').respond();
      ...
      it('should append the user', function() {
        var success = function() {};
        var error = function() {};
        $httpBackend.expectPOST('/v1/auth/login').respond({ 'user': 'bar' });
        Auth.login({}, success, error);
        $httpBackend.flush();
    ...
    describe('logout', function() {
      it('should make a request and invoke callback', function() {
        ...
        var error = function() {};
        $httpBackend.expectPOST('/v1/auth/logout').respond();
